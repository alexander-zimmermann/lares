# Basalte-Logik: Bestandsaufnahme
...
**166 Logikblöcke**, davon **28 mit Push-Benachrichtigung**. 877 benannte Objekte im Export.
...
|---|---|---|---|
| (ohne Namen) | Kritisch: Warmwasser Ist-Temperatur auffällig. | — | — |
...
| Block | Knoten | Bausteine |
|---|---:|---|
| (ohne Namen) | 12 | changedetector×2, knxnumber×2, lookuptable×2, notification×6 |
| (ohne Namen) | 10 | and×1, knxbool×3, linkinput×1, not×2, openclosedevice×1 |
