...
- **Backup Server** — configuration of the running PBS (one of the fleet VMs): OIDC realm and datastores through its API, repositories and the subscription nag over SSH; users and jobs follow as they move out of the first-boot script.
...
│   └── 60-pbs/             #   PBS connection, OIDC realms, host settings, datastores
